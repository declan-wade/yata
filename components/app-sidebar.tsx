...
export function AppSidebar({ todos, tags, ...props }: { todos: any[] } & { tags: any[] } & React.ComponentProps<typeof Sidebar>) {
  ...
  const navMain = [
    ...
    { title: "Due Today", url: "/today", icon: "Hourglass" as const, key: "dueToday" },
    { title: "Due This Week", url: "/week", icon: "CalendarDays" as const, key: "dueThisWeek" },
    { title: "Overdue", url: "/overdue", icon: "AlarmClockCheck" as const, key: "overdue" },
  ];
                            ...
                            <SidebarMenuButton className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground flex items-center justify-between">
                              ...
                              {typeof item.count === "number" && item.count > 0 && (
                                <span
                                  ...
                                  style={{ animation: "fade-in 0.4s cubic-bezier(0.4,0,0.2,1)" }}
                                >
                                  {item.count}
                                </span>
                              )}
